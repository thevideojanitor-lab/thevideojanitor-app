...
const plans = [
  {
    ...
    bestFor: "Creators posting 1x/week",
  ...
  },
  {
    ...
    bestFor: "High-volume creators & brands",
    features: ["24h rush turnaround", "Unlimited revisions", "Dedicated team", "Account manager", "Multi-platform support", "API access"],
    popular: false,
  },
];
